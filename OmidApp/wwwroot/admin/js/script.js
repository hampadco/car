...
(function($) {
    ...
    $('.product-box button .ti-shopping-cart').on('click', function() {
        $.notify({
            ...
            icon_type: 'class',
            template: '<div data-notify="container" class="col-xs-11 col-sm-3 alert alert-{0}" style="direction: rtl;text-align: right" role="alert">' +
    ...
    $('.product-box a .ti-heart , .product-box a .fa-heart').on('click', function() {
        ...
        $.notify({
            icon: 'fa fa-check',
            title: 'موفقیت!',
            message: 'با موفقیت به  علاقه مندی اضاف شد'
        }, {
            element: 'body',
            position: null,
            type: "info",
...
(function() {
    $('<div class="sidebar-btn dark-light-btn">' +
        ...
        '<div class="theme-layout-version">تاریک' +
        '</div>' +
        '</div>' +
        '</div>').appendTo($('body'));
})();
